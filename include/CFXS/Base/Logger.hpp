...
namespace CFXS {
    ...
    public:
        ...
        static void Log(Args&&... args) {
            if constexpr (CFG::ENABLED) {
                printf(CFG::LOG_PREFIX);
